...
:fa-desktop: [plugin:page-inject](/slides/unit-01-1?template=swipedecklinkonly)
:fa-desktop: [plugin:page-inject](/slides/unit-01-2?template=swipedecklinkonly)
:fa-book:[plugin:page-inject](/readings/unit-01?template=embedlycardlinkonly)  
...
:fa-book: [plugin:page-inject](/readings/unit-02?template=embedlycardlinkonly)  
...
:fa-book: [plugin:page-inject](/readings/unit-03?template=embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  
...
:fa-book: [plugin:page-inject](/readings/unit-04?template=embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  
...
:fa-book: [plugin:page-inject](/readings/unit-05?template=embedlycardlinkonly)  
...
:fa-book: [plugin:page-inject](/readings/unit-06?template=embedlycardlinkonly)  
...
:fa-book: [plugin:page-inject](/readings/unit-07?template=embedlycardlinkonly)

#### :fa-calendar: Week 8 (Oct 25 - Oct 31)
**How to design products for how people think, learn and feel?**  
:fa-desktop: Interaction Design  
:fa-book: [plugin:page-inject](/readings/unit-08?template=embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  

#### :fa-calendar: Week 9 (Nov 1 - 7)
**How to design for mobile and multi-device usage?**  
:fa-desktop: Mobile and Multi-device Design  
:fa-book: [plugin:page-inject](/readings/unit-09?template=embedlycardlinkonly)  
:fa-users: In-class office hours (tentative)  
...
:fa-book: [plugin:page-inject](/readings/unit-10?template=embedlycardlinkonly)   
:fa-users: In-class office hours (tentative)  
